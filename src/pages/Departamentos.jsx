...
function Departamentos() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!descripcionLimpia) {
      setError("La descripción del departamento es obligatoria.");
      return;
    }
    ...
    if (error) {
      ...
      if (error.code === "23505") {
        ...
        setError(error.message || "No se pudo crear el departamento.");
      }
    ...
    <section className="departamentos-page">
      <div className="departamentos-header">
        <div>
          ...
          <h1>Departamentos</h1>
          <p>Administra las áreas y departamentos del sistema.</p>
        </div>
      </div>
      ...
      <div className="departamentos-card">
        <div className="departamentos-section">
          ...
          <p>Agrega un nuevo departamento al CRM.</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="departamentos-actions">
            <button
              ...
              disabled={guardando}
            >
              {guardando ? "Guardando..." : "Crear departamento"}
            </button>
          </div>
        </form>
      </div>
      ...
      <div className="departamentos-card">
        <div className="departamentos-section">
          ...
          <p>Consulta las áreas disponibles en el CRM.</p>
        </div>
