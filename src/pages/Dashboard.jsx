...
function Dashboard() {
  ...
  const cargarDashboard = async () => {
    ...
    try {
      ...
      const atrasadas = listaTareas.filter(
        (tarea) => {
          if (
      ...
      // =====================================================
      // ANTICIPACIÓN DE SOLICITUDES
      //
      // created_at = momento en que llegó la solicitud
      // fecha_inicio = momento en que está planificada
      //
      // >= 72 h  -> planificada
      // >= 24 h  -> anticipación corta
      // >= 1 h   -> urgente
      // < 1 h    -> última hora
      // =====================================================
        ...
        <div className="dashboard-panel">
          ...
          <div className="time-summary">
            ...
            <div className="time-item">
              ...
              <span className="dot last-minute" />
