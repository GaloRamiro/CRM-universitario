...
function EditarTarea() {
  ...
  const terminarTarea = async () => {
    ...
    try {
      ...
      setMensaje(
        `Tarea terminada a las ${horaActual}.`
      );
    ...
    <section className="editar-tarea-page">
      ...
      >
        ...
        <div className="editar-tarea-section">
          ...
          <p>
            Modifica los datos principales de
            la actividad.
          </p>
        ...
        <div className="editar-tarea-section">
          ...
          <p>
            Las fechas y horas muestran el
